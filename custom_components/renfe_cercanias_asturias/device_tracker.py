...
from .const import ATTRIBUTION, CONF_DESTINATION, CONF_ORIGIN, DOMAIN
...
class RenfeRouteTrainTracker(CoordinatorEntity[RenfeFleetCoordinator], TrackerEntity):
    ...
    def __init__(
        ...
        self._attr_unique_id = (
            f"route_{entry.data[CONF_ORIGIN]}_{self._destination}_train_position"
        )
    ...
    def extra_state_attributes(self) -> dict:
        ...
        return {
            ...
            "estacion_siguiente": get_station_name(train.estacion_siguiente_codigo),
